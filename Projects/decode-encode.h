...
int decode() {
   ...
   if (choosen == 1) {
      std::string text;
      std::cout << "Enter text u want to encode >: ";
      std::cin >> text;
      std::string encodedtext = b64encode(text);
      ...
      std::string text;
      std::cout << "Enter text u want to decode >: ";
      std::cin >> text;
      std::string decodedtext = b64decode(text);
